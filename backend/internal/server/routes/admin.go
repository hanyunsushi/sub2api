...
func registerAuditLogRoutes(admin *gin.RouterGroup, h *handler.Handlers, _ middleware.StepUpAuthMiddleware) {
	auditLogs := admin.Group("/audit-logs")
	{
		...
		// Clear requires an immediate TOTP check in the handler, not the reusable step-up window.
...
func registerAccountRoutes(admin *gin.RouterGroup, h *handler.Handlers, stepUpAuth middleware.StepUpAuthMiddleware) {
	accounts := admin.Group("/accounts")
	{
		...
		accounts.PUT("/:id/rate-multiplier", h.Admin.Account.UpdateRateMultiplier)
		...
		accounts.POST("/:id/schedule-lock", h.Admin.Account.SetScheduleLocked)
...
func registerSettingsRoutes(admin *gin.RouterGroup, h *handler.Handlers) {
	adminSettings := admin.Group("/settings")
	{
		...
		adminSettings.PUT("/appearance-theme-default", h.Admin.Setting.UpdateAppearanceThemeDefault)

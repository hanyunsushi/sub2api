...
<div class="email-block">
  ...
  <p>If you did not request this code, please ignore this email.</p>
	...
	return buildAnthropicEmailBody(siteName, "Email verification code", content)
}
...
<p class="muted">如果按钮无法点击，请复制以下链接到浏览器中打开：<br>%s</p>`,
		escapedURL,
		int(passwordResetTokenTTL/time.Minute),
		escapedURL,
	)
	return buildAnthropicEmailBody(siteName, "密码重置", content)
}

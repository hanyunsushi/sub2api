...
func (c *Client) Use(hooks ...Hook) {
	for _, n := range []interface{ Use(...Hook) }{
		...
		c.ChannelMonitorRequestTemplate, c.CodexAccountMetadata, c.CodexGroup,
...
type (
	hooks struct {
		...
		ChannelMonitorHistory, ChannelMonitorRequestTemplate, CodexAccountMetadata,
		CodexGroup, ErrorPassthroughRule, Group, IdempotencyRecord,

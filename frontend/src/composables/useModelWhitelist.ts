...
const anthropicPresetMappings = [
  ...
  { label: 'Sonnet 4', from: 'claude-sonnet-4-20250514', to: 'claude-sonnet-4-20250514', color: 'bg-[var(--anthropic-info-bg)] text-[var(--anthropic-info)] hover:bg-[var(--anthropic-info-bg)] dark:bg-[var(--anthropic-info-bg)] dark:text-[var(--anthropic-info)]' },
  ...
  { label: 'Opus 4.5', from: 'claude-opus-4-5-20251101', to: 'claude-opus-4-5-20251101', color: 'bg-accent-200 text-accent-700 hover:bg-accent-300 dark:bg-accent-900/30 dark:text-accent-500' },
  { label: 'Opus 4.6', from: 'claude-opus-4-6', to: 'claude-opus-4-6', color: 'bg-accent-200 text-accent-700 hover:bg-accent-300 dark:bg-accent-900/30 dark:text-accent-500' },
  { label: 'Opus 4.7', from: 'claude-opus-4-7', to: 'claude-opus-4-7', color: 'bg-accent-200 text-accent-700 hover:bg-accent-300 dark:bg-accent-900/30 dark:text-accent-500' },
  { label: 'Opus 4.8', from: 'claude-opus-4-8', to: 'claude-opus-4-8', color: 'bg-accent-200 text-accent-700 hover:bg-accent-300 dark:bg-accent-900/30 dark:text-accent-500' },
...
const openaiPresetMappings = [
  ...
  { label: 'GPT-4o Mini', from: 'gpt-4o-mini', to: 'gpt-4o-mini', color: 'bg-[var(--anthropic-info-bg)] text-[var(--anthropic-info)] hover:bg-[var(--anthropic-info-bg)] dark:bg-[var(--anthropic-info-bg)] dark:text-[var(--anthropic-info)]' },
  ...
  { label: 'o1', from: 'o1', to: 'o1', color: 'bg-accent-200 text-accent-700 hover:bg-accent-300 dark:bg-accent-900/30 dark:text-accent-500' },
  ...
  { label: 'Opus→5.4', from: 'claude-opus-4-6', to: 'gpt-5.4', color: 'bg-accent-200 text-accent-700 hover:bg-accent-300 dark:bg-accent-900/30 dark:text-accent-500' },
  { label: 'Sonnet→5.4', from: 'claude-sonnet-4-6', to: 'gpt-5.4', color: 'bg-[var(--anthropic-info-bg)] text-[var(--anthropic-info)] hover:bg-[var(--anthropic-info-bg)] dark:bg-[var(--anthropic-info-bg)] dark:text-[var(--anthropic-info)]' }
]

const geminiPresetMappings = [
  { label: 'Flash 2.0', from: 'gemini-2.0-flash', to: 'gemini-2.0-flash', color: 'bg-[var(--anthropic-info-bg)] text-[var(--anthropic-info)] hover:bg-[var(--anthropic-info-bg)] dark:bg-[var(--anthropic-info-bg)] dark:text-[var(--anthropic-info)]' },
  ...
  { label: '2.5 Image', from: 'gemini-2.5-flash-image', to: 'gemini-2.5-flash-image', color: 'bg-[var(--anthropic-info-bg)] text-[var(--anthropic-info)] hover:bg-[var(--anthropic-info-bg)] dark:bg-sky-900/30 dark:text-[var(--anthropic-info)]' },
  { label: '2.5 Pro', from: 'gemini-2.5-pro', to: 'gemini-2.5-pro', color: 'bg-accent-200 text-accent-700 hover:bg-accent-300 dark:bg-accent-900/30 dark:text-accent-500' },
  { label: '3.5 Flash', from: 'gemini-3.5-flash', to: 'gemini-3.5-flash', color: 'bg-accent-200 text-accent-700 hover:bg-accent-300 dark:bg-accent-900/30 dark:text-accent-500' },
  { label: '3.1 Image', from: 'gemini-3.1-flash-image', to: 'gemini-3.1-flash-image', color: 'bg-[var(--anthropic-info-bg)] text-[var(--anthropic-info)] hover:bg-[var(--anthropic-info-bg)] dark:bg-sky-900/30 dark:text-[var(--anthropic-info)]' }
]

// Antigravity 预设映射（支持通配符）
const antigravityPresetMappings = [
  // Claude 通配符映射
  { label: 'Claude→Sonnet', from: 'claude-*', to: 'claude-sonnet-4-5', color: 'bg-[var(--anthropic-info-bg)] text-[var(--anthropic-info)] hover:bg-[var(--anthropic-info-bg)] dark:bg-[var(--anthropic-info-bg)] dark:text-[var(--anthropic-info)]' },
  { label: 'Fable 5', from: 'claude-fable-5', to: 'claude-fable-5', color: 'bg-rose-100 text-rose-700 hover:bg-rose-200 dark:bg-rose-900/30 dark:text-rose-400' },
  ...
  { label: 'Opus→Opus', from: 'claude-opus-*', to: 'claude-opus-4-6-thinking', color: 'bg-accent-200 text-accent-700 hover:bg-accent-300 dark:bg-accent-900/30 dark:text-accent-500' },
  ...
  { label: 'Sonnet4→4.6', from: 'claude-sonnet-4-20250514', to: 'claude-sonnet-4-6', color: 'bg-[var(--anthropic-info-bg)] text-[var(--anthropic-info)] hover:bg-[var(--anthropic-info-bg)] dark:bg-sky-900/30 dark:text-[var(--anthropic-info)]' },
  ...
  { label: 'Opus4.5→4.6', from: 'claude-opus-4-5-20251101', to: 'claude-opus-4-6-thinking', color: 'bg-accent-200 text-accent-700 hover:bg-accent-300 dark:bg-accent-900/30 dark:text-accent-500' },
  // Gemini 3→3.1 映射
  ...
  { label: '2.5-Flash-Image透传', from: 'gemini-2.5-flash-image', to: 'gemini-2.5-flash-image', color: 'bg-[var(--anthropic-info-bg)] text-[var(--anthropic-info)] hover:bg-[var(--anthropic-info-bg)] dark:bg-sky-900/30 dark:text-[var(--anthropic-info)]' },
  { label: '3.1-Flash-Image透传', from: 'gemini-3.1-flash-image', to: 'gemini-3.1-flash-image', color: 'bg-[var(--anthropic-info-bg)] text-[var(--anthropic-info)] hover:bg-[var(--anthropic-info-bg)] dark:bg-sky-900/30 dark:text-[var(--anthropic-info)]' },
  { label: '3-Pro-Image→3.1', from: 'gemini-3-pro-image', to: 'gemini-3.1-flash-image', color: 'bg-[var(--anthropic-info-bg)] text-[var(--anthropic-info)] hover:bg-[var(--anthropic-info-bg)] dark:bg-sky-900/30 dark:text-[var(--anthropic-info)]' },

...
const anthropicPresetMappings = [
  ...
  { label: 'Sonnet 4.5', from: 'claude-sonnet-4-5-20250929', to: 'claude-sonnet-4-5-20250929', color: ANTHROPIC_PRESET_CHIP },
  { label: 'Sonnet 4.6', from: 'claude-sonnet-4-6', to: 'claude-sonnet-4-6', color: ANTHROPIC_PRESET_CHIP },
  { label: 'Opus 4.5', from: 'claude-opus-4-5-20251101', to: 'claude-opus-4-5-20251101', color: ANTHROPIC_PRESET_CHIP },
  ...
  { label: 'Opus 5.5', from: 'claude-opus-5-5', to: 'claude-opus-5-5', color: ANTHROPIC_PRESET_CHIP },
...
const openaiPresetMappings = [
  ...
  { label: 'Haiku→5.4', from: 'claude-haiku-4-5-20251001', to: 'gpt-5.4', color: ANTHROPIC_PRESET_CHIP },
  { label: 'Opus→5.4', from: 'claude-opus-4-6', to: 'gpt-5.4', color: ANTHROPIC_PRESET_CHIP },
  { label: 'Sonnet→5.4', from: 'claude-sonnet-4-6', to: 'gpt-5.4', color: ANTHROPIC_PRESET_CHIP }
]
...
const antigravityPresetMappings = [
  ...
  { label: 'Haiku→Sonnet', from: 'claude-haiku-*', to: 'claude-sonnet-4-5', color: ANTHROPIC_PRESET_CHIP },
  { label: 'Sonnet4→4.6', from: 'claude-sonnet-4-20250514', to: 'claude-sonnet-4-6', color: ANTHROPIC_PRESET_CHIP },
  { label: 'Sonnet4.5→4.6', from: 'claude-sonnet-4-5-20250929', to: 'claude-sonnet-4-6', color: ANTHROPIC_PRESET_CHIP },
  { label: 'Sonnet3.5→4.6', from: 'claude-3-5-sonnet-20241022', to: 'claude-sonnet-4-6', color: ANTHROPIC_PRESET_CHIP },
  { label: 'Opus4.5→4.6', from: 'claude-opus-4-5-20251101', to: 'claude-opus-4-6-thinking', color: ANTHROPIC_PRESET_CHIP },
  // Gemini 3→3.1 映射
  ...
  // 精确映射
  { label: 'Sonnet 4.6', from: 'claude-sonnet-4-6', to: 'claude-sonnet-4-6', color: ANTHROPIC_PRESET_CHIP },
  { label: 'Sonnet 4.5', from: 'claude-sonnet-4-5', to: 'claude-sonnet-4-5', color: ANTHROPIC_PRESET_CHIP },
  { label: 'Opus 4.6', from: 'claude-opus-4-6', to: 'claude-opus-4-6-thinking', color: ANTHROPIC_PRESET_CHIP },
  { label: 'Opus 4.6-thinking', from: 'claude-opus-4-6-thinking', to: 'claude-opus-4-6-thinking', color: ANTHROPIC_PRESET_CHIP },
  { label: 'Opus 4.7', from: 'claude-opus-4-7', to: 'claude-opus-4-7', color: ANTHROPIC_PRESET_CHIP },
  { label: 'Opus 4.8', from: 'claude-opus-4-8', to: 'claude-opus-4-8', color: ANTHROPIC_PRESET_CHIP }
]
...
const bedrockPresetMappings = [
  ...
  { label: 'Opus 4.8', from: 'claude-opus-4-8', to: 'us.anthropic.claude-opus-4-8-v1', color: ANTHROPIC_PRESET_CHIP },
  { label: 'Sonnet 5', from: 'claude-sonnet-5', to: 'us.anthropic.claude-sonnet-5-v1', color: ANTHROPIC_PRESET_CHIP },
  { label: 'Sonnet 4.6', from: 'claude-sonnet-4-6', to: 'us.anthropic.claude-sonnet-4-6', color: ANTHROPIC_PRESET_CHIP },
  { label: 'Opus 4.5', from: 'claude-opus-4-5-thinking', to: 'us.anthropic.claude-opus-4-5-20251101-v1:0', color: ANTHROPIC_PRESET_CHIP },
  { label: 'Sonnet 4.5', from: 'claude-sonnet-4-5', to: 'us.anthropic.claude-sonnet-4-5-20250929-v1:0', color: ANTHROPIC_PRESET_CHIP },
  { label: 'Haiku 4.5', from: 'claude-haiku-4-5', to: 'us.anthropic.claude-haiku-4-5-20251001-v1:0', color: ANTHROPIC_PRESET_CHIP },
]

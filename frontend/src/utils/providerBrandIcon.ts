...
const modelBrandMap: Array<[string[], ProviderBrandPreset]> = [
  ...
  [['deepseek'], providerBrandMap[3][1]],
  [['doubao'], providerBrandMap[4][1]],
  [['openrouter'], providerBrandMap[5][1]],
  [['mistral', 'mixtral', 'codestral'], providerBrandMap[6][1]],
  [['qwen', 'qwq'], providerBrandMap[7][1]],
  [['command', 'cohere'], providerBrandMap[8][1]],
  [['perplexity', 'pplx'], providerBrandMap[9][1]],
  [['moonshot', 'kimi'], providerBrandMap[10][1]],
  [['glm', 'chatglm'], providerBrandMap[11][1]],
  [['grok'], providerBrandMap[12][1]],
  [['llama'], providerBrandMap[15][1]],
  [['ernie', 'wenxin'], providerBrandMap[16][1]],
  [['spark'], providerBrandMap[17][1]],
  [['hunyuan'], providerBrandMap[18][1]],
  [['minimax', 'abab'], providerBrandMap[19][1]],
  [['jina'], providerBrandMap[20][1]],
  [['midjourney', 'mj_'], providerBrandMap[21][1]],
  [['suno'], providerBrandMap[22][1]],
  [['360'], providerBrandMap[23][1]],
  [['dify'], providerBrandMap[24][1]],
  [['coze'], providerBrandMap[25][1]],
]

...
describe('home CTA StarBorder integration', () => {
  ...
  it('keeps later home sections on warm paper surfaces with restrained provider logos', () => {
    ...
    expect(capabilityFeaturedBlock).toContain('background: var(--atelier-paper);')
    expect(capabilityFeaturedBlock).toContain('box-shadow: inset 0 4px 0 var(--atelier-butter);')
    ...
    expect(logoMarkBlock).toContain('width: 44px;')
    expect(logoMarkBlock).toContain('height: 44px;')
    expect(mobileBlock).toContain('width: 38px;')
    expect(mobileBlock).toContain('height: 38px;')

...
describe('Klein blue theme', () => {
  ...
  it('maps the light UI surfaces to the Atelier Zero palette without a warm yellow wash', () => {
    ...
    expect(globalStyle).toContain('--atelier-canvas: #d9deee;')
    expect(globalStyle).toContain('--atelier-surface-panel: #fffaf0;')
    expect(globalStyle).toContain('--atelier-surface-dust: #d9ddd7;')
    expect(globalStyle).toContain('--atelier-material-butter: var(--atelier-butter-soft);')
    expect(globalStyle).toContain('--atelier-material-butter-strong: #d8bf83;')

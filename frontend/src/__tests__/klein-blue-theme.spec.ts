...
describe('Klein blue theme', () => {
  ...
  it('maps the light UI surfaces to the Atelier Zero palette with warm paper as the dominant canvas', () => {
    ...
    expect(globalStyle).toContain('--atelier-canvas: color-mix(in srgb, var(--atelier-dust) 12%, var(--atelier-paper));')
    expect(globalStyle).toContain('--atelier-surface-panel: #fffaf0;')
    ...
    expect(globalStyle).toContain('--atelier-material-1: var(--atelier-paper);')
    expect(globalStyle).not.toContain('--atelier-canvas: #d9deee;')
    expect(globalStyle).not.toContain('--atelier-canvas: var(--atelier-paper);')
    ...
    expect(codexTheme).toContain('--material-card-surface: var(--atelier-paper);')

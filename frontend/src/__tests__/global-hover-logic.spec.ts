...
describe('Anthropic hover and overlay taxonomy', () => {
  ...
  it('keeps header and sidebar hover aligned with the Anthropic examples', () => {
    ...
    expect(targetedRepairSource).toContain('text-decoration: none !important;')
    expect(targetedRepairSource).toContain('content: "[";')
    expect(targetedRepairSource).toContain('content: "]";')
  ...
  it('keeps filter text controls out of the button/focus-blue taxonomy', () => {
    ...
    expect(dateRangePickerSource).toContain('outline-offset: 3px !important;')
    ...
    expect(dashboardTextControlTriggerBlock).toContain('text-decoration: none !important;')
  ...
  it('preserves account rows as domain cards instead of flattening them to generic tables', () => {
    ...
    const finalAccountCardsIndex = targetedRepairSource.indexOf('/* Account cards: final Anthropic grouped-card contract.')
    const wrapperChromeBlock = cssBlock(targetedRepairSource, '#app .app-layout-content .accounts-table-page .layout-section-scrollable,', finalAccountCardsIndex)
    ...
    const domainCardBaseBlock = cssBlock(targetedRepairSource, '#app .app-layout-content .accounts-table-page .table-wrapper tbody tr', finalAccountCardsIndex)
  ...
  it('keeps dropdowns inherited, warm, and lightly shadowed', () => {
    ...
    expect(accountToolsItemBlock).toContain('text-decoration: none;')
    ...
    expect(accountToolsItemHoverBlock).toContain('text-decoration: none;')

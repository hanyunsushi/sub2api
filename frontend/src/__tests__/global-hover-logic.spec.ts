...
describe('Anthropic hover and overlay taxonomy', () => {
  ...
  it('keeps filter text controls out of the button/focus-blue taxonomy', () => {
    ...
    expect(finalFormKeyboardFocusBlock).toContain('outline: 2px solid var(--anthropic-border-hover) !important;')
  ...
  it('keeps authentication pages on the same button, input, checkbox, and logo contract', () => {
    ...
    const authInputMouseFocusBlock = cssBlock(targetedRepairSource, '.auth-ascii-shell :where(.input, input[type="text"], input[type="search"], input[type="email"], input[type="password"], input[type="number"], input[type="date"], input[type="tel"], textarea, select):where(:hover, :focus):not(:focus-visible)')
    expect(authInputMouseFocusBlock).toContain('outline: 0 !important;')
    expect(authInputMouseFocusBlock).toContain('box-shadow: none !important;')
    const authInputKeyboardFocusBlock = cssBlock(targetedRepairSource, '.auth-ascii-shell :where(.input, input[type="text"], input[type="search"], input[type="email"], input[type="password"], input[type="number"], input[type="date"], input[type="tel"], textarea, select):where(:focus-visible)')
    expect(authInputKeyboardFocusBlock).toContain('outline: 2px solid var(--anthropic-focus) !important;')

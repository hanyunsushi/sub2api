...
describe('home and auth contrast on Atelier structured color surfaces', () => {
  ...
  it('rebuilds the default home page with opaque IKB and dust hierarchy instead of a warm yellow grid wash', () => {
    ...
    expect(home).toContain('background: var(--home-surface-solid);')
    expect(home).not.toContain('background: var(--atelier-surface-panel);')
    ...
    expect(home).not.toContain('border: 1px dotted rgba(23, 21, 18, 0.42)')
    expect(home).not.toContain('background: var(--atelier-butter);')
    ...
    expect(home).toContain('--home-card-accent: var(--atelier-dust);')
    expect(home).toContain('--home-chip-accent: var(--atelier-blue-dark);')

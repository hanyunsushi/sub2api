  ...
  <div class="relative inline-block">
    <span
      ...
      :class="[
        ...
        effectivePlatform
          ...
          : 'border-[var(--anthropic-border)] bg-[var(--anthropic-section)] text-[var(--anthropic-muted)] dark:border-[var(--anthropic-border)] dark:bg-[var(--anthropic-section)] dark:text-[var(--anthropic-muted)]',
      ]"
      @mouseenter="onEnter"
      @mouseleave="onLeave"
      @focusin="onEnter"
    ...
    >
      ...
      <span
        ...
        class="rounded bg-[var(--anthropic-raised)] px-1 text-[10px] uppercase text-[var(--anthropic-muted)] dark:bg-[var(--anthropic-section)] dark:text-[var(--anthropic-muted)]"
      >
        {{ model.platform }}
      </span>
      {{ model.name }}
    ...
    <Teleport to="body">
      <div
        ...
        ref="popoverEl"
        role="tooltip"
        class="pointer-events-none fixed z-[99999] w-80 max-w-[min(22rem,calc(100vw-1rem))] rounded-lg border bg-[var(--anthropic-page)] text-xs shadow-none dark:bg-[var(--anthropic-section)]"
      ...
      >
        ...
        >
          ...
          <span
            v-if="model.platform"
            class="flex-shrink-0 rounded bg-[var(--anthropic-page)] px-1.5 py-0.5 text-[10px] uppercase tracking-wide dark:bg-[var(--anthropic-section)]"
          >
            {{ model.platform }}
          </span>
        </div>
        ...
        <div class="p-3">
          <div v-if="!model.pricing" class="text-[var(--anthropic-muted)] dark:text-[var(--anthropic-muted)]">
            {{ noPricingLabel }}
          </div>

          <div v-else class="space-y-2 text-[var(--anthropic-muted)] dark:text-[var(--anthropic-muted)]">
            <div class="flex justify-between">
              <span class="text-[var(--anthropic-muted)] dark:text-[var(--anthropic-muted)]">{{ t(prefixKey('billingMode')) }}</span>
            ...
            <div
              ...
              :class="[popoverBorderClass]"
            >
              <div class="mb-1 font-medium text-[var(--anthropic-muted)] dark:text-[var(--anthropic-muted)]">
...
const popoverHeaderClass = computed(() =>
  effectivePlatform.value
    ...
    : 'bg-[var(--anthropic-section)] text-[var(--anthropic-muted)] dark:bg-[var(--anthropic-section)] dark:text-[var(--anthropic-muted)]',
)

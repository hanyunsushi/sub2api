          ...
          >
            ...
            <div class="relative overflow-hidden border-b border-accent-100 bg-primary-50/80 px-8 py-6 dark:border-dark-700 dark:bg-primary-900/10">
              ...
              <div class="relative z-10 flex items-start justify-between gap-4">
                ...
                <button
                  @click="closeDetail"
                  class="flex h-10 w-10 flex-shrink-0 items-center justify-center rounded-lg bg-white/50 text-gray-500 backdrop-blur-sm transition-all hover:bg-white hover:text-gray-700 hover:shadow-lg dark:bg-dark-700/50 dark:text-gray-400 dark:hover:bg-dark-700 dark:hover:text-gray-300"
                  :aria-label="t('common.close')"
                >
                  <Icon name="x" size="md" />
                </button>

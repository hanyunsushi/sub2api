<template>
  <div v-if="controller.visible.value" class="fixed inset-0 z-[60] overflow-y-auto">
    <div class="flex min-h-full items-center justify-center p-4">
      <div data-testid="merge-totp-step-up-dialog-handle-cancel-1" class="fixed inset-0 bg-black/50 transition-opacity" @click="handleCancel"></div>
      ...
      <div class="relative w-full max-w-md transform rounded-xl bg-white p-6 shadow-xl transition-all dark:bg-dark-800">
        ...
        <div class="mb-6">
          <input data-testid="merge-totp-step-up-dialog-text-2"
          ...
          <div class="flex justify-center gap-2">
            <input data-testid="merge-totp-step-up-dialog-input-3-3"
              v-for="(_, index) in 6"
              :key="index"
        ...
        <button data-testid="merge-totp-step-up-dialog-handle-cancel-4"
          type="button"

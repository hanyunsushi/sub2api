<template>
  ...
  <div class="grid grid-cols-2 gap-4 lg:grid-cols-4">
    ...
    <div v-if="!isSimple" class="card p-4">
      <div class="flex items-center gap-3">
        <div class="dashboard-stat-icon">
          <svg class="h-5 w-5 text-primary-500 dark:text-primary-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div>
          ...
          <p class="text-xl font-bold text-primary-500 dark:text-primary-300">${{ formatBalance(balance) }}</p>
    ...
    <div class="card p-4">
      <div class="flex items-center gap-3">
        <div class="dashboard-stat-icon">
          <Icon name="key" size="md" class="text-primary-500 dark:text-primary-300" :stroke-width="2" />
        </div>
        <div>
    ...
    <div class="card p-4">
      <div class="flex items-center gap-3">
        <div class="dashboard-stat-icon">
          <Icon name="chart" size="md" class="text-primary-500 dark:text-primary-300" :stroke-width="2" />
        </div>
        <div>
    ...
    <div class="card p-4">
      <div class="flex items-center gap-3">
        <div class="dashboard-stat-icon">
          <Icon name="dollar" size="md" class="text-primary-500 dark:text-primary-300" :stroke-width="2" />
        </div>
        <div>
          <p class="text-xs font-medium text-gray-500 dark:text-gray-400">{{ t('dashboard.todayCost') }}</p>
          <p class="text-xl font-bold text-gray-900 dark:text-white">
            <span class="text-primary-500 dark:text-primary-300" :title="t('dashboard.actual')">${{ formatCost(stats?.today_actual_cost || 0) }}</span>
          ...
          <p class="text-xs">
            ...
            <span class="text-primary-500 dark:text-primary-300" :title="t('dashboard.actual')">${{ formatCost(stats?.total_actual_cost || 0) }}</span>
  ...
  <div class="grid grid-cols-2 gap-4 lg:grid-cols-4">
    ...
    <div class="card p-4">
      <div class="flex items-center gap-3">
        <div class="dashboard-stat-icon">
          <Icon name="cube" size="md" class="text-primary-500 dark:text-primary-300" :stroke-width="2" />
        </div>
        <div>
    ...
    <div class="card p-4">
      <div class="flex items-center gap-3">
        <div class="dashboard-stat-icon">
          <Icon name="database" size="md" class="text-primary-500 dark:text-primary-300" :stroke-width="2" />
        </div>
        <div>
    ...
    <div class="card p-4">
      <div class="flex items-center gap-3">
        <div class="dashboard-stat-icon">
          <Icon name="bolt" size="md" class="text-primary-500 dark:text-primary-300" :stroke-width="2" />
        </div>
        <div class="flex-1">
          ...
          <div class="flex items-baseline gap-2">
            <p class="text-sm font-semibold text-primary-500 dark:text-primary-300">{{ formatTokens(stats?.tpm || 0) }}</p>
    ...
    <div class="card p-4">
      <div class="flex items-center gap-3">
        <div class="dashboard-stat-icon">
          <Icon name="clock" size="md" class="text-primary-500 dark:text-primary-300" :stroke-width="2" />
        </div>
        <div>

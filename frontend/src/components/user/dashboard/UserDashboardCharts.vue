  ...
  <div class="space-y-6">
    ...
    <div class="card p-4">
      <div class="flex flex-wrap items-center gap-4">
        ...
        <button data-testid="user-dashboard-user-dashboard-charts-button-emit-refresh" @click="$emit('refresh')" :disabled="loading" class="btn btn-secondary">
          {{ t('common.refresh') }}
        </button>
            ...
            <table class="w-full text-xs">
              ...
              <tbody>
                <tr v-for="model in models" :key="model.model" class="border-t border-gray-100 dark:border-gray-700">
                  ...
                  <td class="py-1.5 text-right text-primary-500 dark:text-primary-300">${{ formatCost(model.actual_cost) }}</td>

      ...
      >
        <div class="flex items-start gap-3">
          ...
          <div class="flex-1 space-y-2">
            <div class="h-4 w-2/3 rounded bg-[var(--anthropic-raised)] dark:bg-[var(--anthropic-section)]"></div>
            <div class="h-3 w-1/2 rounded bg-[var(--anthropic-raised)] dark:bg-[var(--anthropic-section)]"></div>
          </div>
          <div class="h-6 w-16 rounded-full bg-[var(--anthropic-raised)] dark:bg-[var(--anthropic-section)]"></div>
        </div>
        <div class="mt-5 grid grid-cols-2 gap-2">
          <div class="h-16 rounded-xl bg-[var(--anthropic-raised)] dark:bg-[var(--anthropic-section)]"></div>
          <div class="h-16 rounded-xl bg-[var(--anthropic-raised)] dark:bg-[var(--anthropic-section)]"></div>
        </div>
        <div class="mt-6 h-5 w-full rounded bg-[var(--anthropic-raised)] dark:bg-[var(--anthropic-section)]"></div>
      </div>
    </div>

    ...
    <div :class="props.embedded ? 'space-y-3' : 'flex flex-col gap-5 px-6 py-6 sm:flex-row sm:items-start'">
      <div
        :class="props.embedded
          ? 'flex h-16 w-16 shrink-0 items-center justify-center overflow-hidden rounded-lg bg-[var(--atelier-ink)] text-xl font-bold text-white shadow-none'
          : 'flex h-24 w-24 shrink-0 items-center justify-center overflow-hidden rounded-lg bg-[var(--atelier-ink)] text-3xl font-bold text-white shadow-none'"
      >
        <img
      ...
      <div :class="props.embedded ? 'space-y-3' : 'min-w-0 flex-1 space-y-4'">
        <div class="space-y-1">
          <p v-if="props.embedded" class="text-sm font-semibold text-[var(--anthropic-fg)] dark:text-[var(--anthropic-fg)]">
            {{ t('profile.avatar.title') }}
          </p>
          <p v-else class="text-sm font-medium text-[var(--anthropic-fg)] dark:text-[var(--anthropic-fg)]">
            {{ displayName }}
          </p>

  ...
  >
    <div class="space-y-4">
      <div v-if="loading" class="flex items-center justify-center py-8">
        <svg class="h-6 w-6 animate-spin text-[var(--anthropic-muted)]" fill="none" viewBox="0 0 24 24">
          <circle
            class="opacity-25"
            cx="12"
            cy="12"
      ...
      <div v-else-if="!isActive" class="rounded-lg border border-[var(--anthropic-border)] p-4 text-sm text-[var(--anthropic-muted)] dark:border-[var(--anthropic-border)] dark:text-[var(--anthropic-muted)]">
      ...
      <div v-else class="space-y-4">
        ...
        <div class="rounded-lg border border-[var(--anthropic-border)] p-4 dark:border-[var(--anthropic-border)]">
          ...
          <p class="mt-1 text-sm font-medium text-[var(--anthropic-fg)] dark:text-[var(--anthropic-muted)]">
            {{ account?.name || '-' }}
          </p>
        </div>
        ...
        <div class="rounded-lg border border-[var(--anthropic-border)] p-3 dark:border-[var(--anthropic-border)]">
          ...
          <div class="mt-2 rounded bg-[var(--anthropic-section)] p-2 text-xs text-[var(--anthropic-muted)] dark:bg-[var(--anthropic-section)] dark:text-[var(--anthropic-muted)]">
            {{ state?.error_message || '-' }}
          </div>
        </div>
      </div>

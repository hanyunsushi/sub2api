  ...
  >
    <div class="space-y-6">
      ...
      >
        <div class="flex items-center gap-3">
          ...
          >
            <Icon name="chartBar" size="md" class="text-[var(--anthropic-page)]" :stroke-width="2" />
          </div>
          <div>
        ...
        <div class="grid grid-cols-2 gap-4 lg:grid-cols-4">
          ...
          >
            <div class="mb-2 flex items-center justify-between">
              ...
              <div class="anthropic-stat-icon anthropic-stat-icon-success">
                <svg
                  class="h-4 w-4"
                  fill="none"
                  viewBox="0 0 24 24"
            ...
            <p class="anthropic-stat-value text-2xl font-semibold">
          ...
          >
            <div class="mb-2 flex items-center justify-between">
              ...
              <div class="anthropic-stat-icon anthropic-stat-icon-info">
          ...
          >
            <div class="mb-2 flex items-center justify-between">
              ...
              <div class="anthropic-stat-icon anthropic-stat-icon-warning">
                <Icon
                  name="calculator"
                  size="sm"
          ...
          >
            <div class="mb-2 flex items-center justify-between">
              ...
              <div class="anthropic-stat-icon anthropic-stat-icon-primary">
                <svg
                  class="h-4 w-4"
                  fill="none"
                  viewBox="0 0 24 24"
        ...
        <div class="grid grid-cols-1 gap-4 lg:grid-cols-3">
          ...
          <div class="anthropic-stat-card">
            <div class="mb-3 flex items-center gap-2">
              ...
              <span class="text-sm font-semibold text-[var(--anthropic-fg)]">{{
                t('admin.accounts.stats.todayOverview')
              }}</span>
            </div>
            <div class="space-y-2">
              <div class="flex items-center justify-between">
                <span class="text-xs text-[var(--anthropic-muted)] dark:text-[var(--anthropic-muted)]">{{ t('usage.accountBilled') }}</span>
                <span class="text-sm font-semibold text-[var(--anthropic-fg)]"
                  >${{ formatCost(stats.summary.today?.cost || 0) }}</span
                >
              </div>
              <div class="flex items-center justify-between">
                <span class="text-xs text-[var(--anthropic-muted)] dark:text-[var(--anthropic-muted)]">{{ t('usage.userBilled') }}</span>
                <span class="text-sm font-semibold text-[var(--anthropic-fg)]"
          ...
          <div class="anthropic-stat-card">
            ...
            <div class="space-y-2">
              ...
              <div class="flex items-center justify-between">
                <span class="text-xs text-[var(--anthropic-muted)] dark:text-[var(--anthropic-muted)]">{{ t('usage.accountBilled') }}</span>
                <span class="text-sm font-semibold text-[var(--anthropic-warning)]"
      ...
      <div
        v-else-if="!loading"
        class="flex flex-col items-center justify-center py-12 text-[var(--anthropic-muted)] dark:text-[var(--anthropic-muted)]"
      >
    ...
    <template #footer>
      <div class="flex justify-end">
        <button data-testid="account-account-stats-button-handle-close"
          @click="handleClose"
...
import { accountStatsChartColors, withChartAlpha } from '@/utils/chartColors'
    ...
    datasets: [
      {
        ...
        borderColor: accountStatsChartColors.accountBilled,
        backgroundColor: withChartAlpha(accountStatsChartColors.accountBilled, 0.1),
        fill: true,
        tension: 0.3,
        yAxisID: 'y'
      },
      {
        ...
        borderColor: accountStatsChartColors.userBilled,
        backgroundColor: withChartAlpha(accountStatsChartColors.userBilled, 0.08),
        fill: false,
        tension: 0.3,
        borderDash: [5, 5],
        yAxisID: 'y'
      },
      {
        ...
        borderColor: accountStatsChartColors.requests,
        backgroundColor: withChartAlpha(accountStatsChartColors.requests, 0.1),
        fill: false,
        tension: 0.3,
        yAxisID: 'y1'
      }
...
const lineChartOptions = computed(() => ({
  ...
  scales: {
    ...
    y: {
      ...
      ticks: {
        color: accountStatsChartColors.accountBilled,
        font: {
          size: 10
        },
    ...
    y1: {
      ...
      ticks: {
        color: accountStatsChartColors.requests,
        font: {
          size: 10
        },

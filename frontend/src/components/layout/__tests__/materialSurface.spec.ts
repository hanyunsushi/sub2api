...
describe('right-side material surfaces', () => {
  it('ships a single atelier component material pass for all maintained component families', () => {
    ...
    expect(styleSource).toContain('--atelier-canvas: color-mix(in srgb, var(--atelier-dust) 12%, var(--atelier-paper));')
    ...
    expect(styleSource).toContain('--atelier-material-butter-strong: color-mix(in srgb, var(--atelier-butter) 34%, var(--atelier-paper));')
  ...
  it('themes old white and gray component internals with the full atelier palette', () => {
    ...
    expect(styleSource).not.toContain('--atelier-canvas: var(--atelier-paper);')

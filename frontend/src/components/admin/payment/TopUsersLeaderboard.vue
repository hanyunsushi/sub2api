  ...
  <div class="card p-4">
    ...
    <div v-else class="space-y-2">
      <div v-for="[currency, currencyUsers] in sortedUsers(props.users)" :key="currency" class="space-y-2">
        ...
        <div v-for="(user, idx) in currencyUsers" :key="user.user_id" class="flex items-center justify-between rounded-lg px-3 py-2 hover:bg-[var(--anthropic-section)] dark:hover:bg-[var(--anthropic-raised)]">

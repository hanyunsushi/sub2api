    ...
    <form id="import-data-form" class="space-y-4" @submit.prevent="handleImport">
      ...
      <div>
        ...
        <div
          ...
          :class="dragActive
            ? 'border-[var(--anthropic-fg)] bg-[var(--anthropic-raised)] dark:border-[var(--anthropic-border)] dark:bg-[var(--anthropic-raised)]'
            : 'border-[var(--anthropic-border)] bg-[var(--anthropic-section)] dark:border-[var(--anthropic-border)] dark:bg-[var(--anthropic-section)]'"
        ...
        >
          <div class="min-w-0">
            <div class="truncate text-sm text-[var(--anthropic-muted)] dark:text-dark-200" :title="fileListTitle">

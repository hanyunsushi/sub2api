<template>
  <div class="space-y-4">
    ...
    <div v-else-if="initError" class="card p-6 text-center">
      ...
      <button data-testid="payment-stripe-payment-inline-button-emit-back" class="btn btn-secondary mt-4" @click="$emit('back')">{{ t('payment.result.backToRecharge') }}</button>
    </div>
    <!-- Success -->
    <template v-else-if="success">
      <div class="card p-6">
        <div class="flex flex-col items-center space-y-4 py-4">
          ...
          <button data-testid="payment-stripe-payment-inline-button-emit-done" class="btn btn-primary" @click="$emit('done')">{{ t('common.confirm') }}</button>
        </div>
      </div>
    </template>
    <template v-else>
      ...
      <div class="card p-6">
        ...
        <button data-testid="payment-stripe-payment-inline-button-handle-pay" class="btn btn-stripe mt-6 w-full py-3 text-base" :disabled="submitting || !ready" @click="handlePay">
      ...
      <!-- Cancel order -->
      <button data-testid="payment-stripe-payment-inline-button-handle-cancel" class="btn btn-secondary w-full" :disabled="cancelling" @click="handleCancel">

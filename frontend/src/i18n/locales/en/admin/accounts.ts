export default {
    accounts: {
      ...
      form: {
        ...
        priorityHint: 'Higher priority accounts are preferred for scheduling.',
        priorityLabel: 'Priority',
        selectPlatform: 'Select platform',
        selectType: 'Select type',
        statusLabel: 'Status',
        typeLabel: 'Type',
        weightHint: 'Higher weight receives more requests.',
        weightLabel: 'Weight',
      },
      noAccounts: 'No accounts found',
      noAccountsDescription: 'Create an account to start using this platform.',

  ...
  admin: {
    ...
    codex: {
      accounts: {
        ...
        newGroup: '新分组名称',
        createGroup: '创建分组',
        uploadAuthFile: '上传 JSON',
        uploadingAuthFile: '上传中...',
        codexOAuth: 'Codex OAuth',
        openingOAuth: '打开中...',
        deleteAuthFile: '删除 CPA 授权文件',
        deleteAuthFileNamed: '删除 CPA 授权文件 {name}',
        deleteDisabled: '仅 CPA 文件型账号可删除',
        deleteConfirm: '确认删除 CPA 授权文件“{name}”？该账号在 Sub2 中的元数据也会同步移除。',
        invalidAuthFile: '请选择 .json 授权文件',
        uploadFailed: '上传 CPA 授权文件失败',
        uploadSucceeded: '已上传 CPA 授权文件 {name}',
        deleteFailed: '删除 CPA 授权文件失败',
        deleteSucceeded: '已删除 CPA 授权文件 {name}',
        oauthFailed: '打开 Codex OAuth 地址失败',

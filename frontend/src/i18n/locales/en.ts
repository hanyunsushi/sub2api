  ...
  admin: {
    ...
    codex: {
      accounts: {
        ...
        allStatus: 'All status',
        empty: 'No Codex accounts found',
        noGroup: 'No group',
        metadataEditor: 'Metadata',
        selectAccount: 'Select an account to edit metadata',
        ...
        uploadAuthFile: 'Upload JSON',
        uploadingAuthFile: 'Uploading...',
        codexOAuth: 'Codex OAuth',
        openingOAuth: 'Opening...',
        deleteAuthFile: 'Delete CPA auth file',
        deleteAuthFileNamed: 'Delete CPA auth file {name}',
        deleteDisabled: 'Only CPA file accounts can be deleted',
        deleteConfirm: 'Delete CPA auth file "{name}"? Sub2 metadata for this account will also be removed.',
        invalidAuthFile: 'Please select a .json auth file',
        uploadFailed: 'Failed to upload CPA auth file',
        uploadSucceeded: 'Uploaded CPA auth file {name}',
        deleteFailed: 'Failed to delete CPA auth file',
        deleteSucceeded: 'Deleted CPA auth file {name}',
        oauthFailed: 'Failed to open Codex OAuth URL',

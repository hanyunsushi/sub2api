export default {
  ...
  keys: {
    ...
    logoUrlHint: 'Optional Lobe Icons, Simple Icons, or custom image URL. Leave blank to use the default key icon.',
  ...
  admin: {
    ...
    channels: {
      ...
      form: {
        ...
        logoUrl: 'Logo URL',
        logoUrlHint: 'Optional Lobe Icons, Simple Icons, or custom image URL. Leave blank to use the default icon.',
        description: 'Description',

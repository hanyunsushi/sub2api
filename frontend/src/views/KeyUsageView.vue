  ...
  <div class="relative flex min-h-screen flex-col bg-gray-50 dark:bg-dark-950">
    ...
    <header class="relative z-20 px-6 py-4">
      <nav class="mx-auto flex max-w-6xl items-center justify-between">
        <router-link to="/home" class="flex items-center gap-3">
          ...
          <span class="text-lg font-semibold tracking-normal text-gray-900 dark:text-white">{{ siteName }}</span>
        </router-link>
    ...
    <main class="flex-1 w-full max-w-5xl mx-auto px-6 py-12">
      ...
      <div class="text-center mb-12">
        <h1 class="text-3xl sm:text-4xl font-bold tracking-normal mb-3 text-gray-900 dark:text-white">
          {{ t('keyUsage.title') }}
        </h1>
        ...
        <div v-else-if="resultData" class="space-y-6">
          ...
          <div v-if="ringItems.length > 0" :class="ringGridClass">
            <div
              ...
              :key="i"
              class="fade-up rounded-2xl border border-gray-200 bg-white/90 p-8 transition-all duration-300 hover:shadow-lg dark:border-dark-700 dark:bg-dark-900/90"
          ...
          <div
            ...
            class="fade-up fade-up-delay-3 rounded-2xl border border-gray-200 bg-white/90 overflow-hidden dark:border-dark-700 dark:bg-dark-900/90"
          >
          ...
          <div
            ...
            class="fade-up fade-up-delay-4 rounded-2xl border border-gray-200 bg-white/90 overflow-hidden dark:border-dark-700 dark:bg-dark-900/90"
          >
            <div class="px-8 py-5 border-b border-gray-200 dark:border-dark-700">

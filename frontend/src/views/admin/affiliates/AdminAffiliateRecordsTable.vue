    ...
    <TablePageLayout>
      <template #filters>
        <div class="flex flex-wrap items-center gap-3">
          ...
          <button data-testid="admin-affiliates-admin-affiliate-records-table-button-load-records" class="btn btn-secondary px-2 md:px-3" :disabled="loading" :title="t('common.refresh')" @click="loadRecords">

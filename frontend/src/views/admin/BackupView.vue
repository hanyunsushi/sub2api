<template>
    <div class="space-y-6">
      ...
      <div class="card p-6" data-testid="backup-schedule">
        ...
        <div class="mt-4">
          <button data-testid="admin-backup-button-save-schedule" type="button" class="btn btn-primary btn-sm" :disabled="savingSchedule || !!scheduleValidationError" @click="saveSchedule">

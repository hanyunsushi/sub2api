...
describe('admin DashboardView', () => {
  ...
  it('uses a single dashboard material card layer while keeping controls flat', () => {
    ...
    expect(dashboardSource).not.toContain('.admin-dashboard-atelier :deep(.card)')
    ...
    expect(dashboardSource).toContain('background: var(--atelier-blue-soft);')
    expect(dashboardSource).toContain('.admin-dashboard-atelier :deep(.card:nth-child(4n + 2))')
    expect(dashboardSource).toContain('background: var(--atelier-butter-soft);')
    ...
    expect(globalStyleSource).toContain('#11100d')
    expect(globalStyleSource).toContain('.app-layout-content .card')
    expect(globalStyleSource).toContain('.app-layout-content .admin-material-surface')
    ...
    expect(globalCardSource).not.toContain('inset 0 -1px')
  })
})

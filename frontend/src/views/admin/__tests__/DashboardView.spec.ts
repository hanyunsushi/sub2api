...
describe('admin DashboardView', () => {
  ...
  it('uses a single dashboard material card layer while keeping controls flat', () => {
    ...
    expect(dashboardSource).toContain('--dashboard-control-surface: color-mix(in srgb, var(--atelier-dust) 8%, var(--atelier-white));')
    ...
    expect(dashboardSource).toContain('background: color-mix(in srgb, var(--atelier-blue) 7%, var(--atelier-white));')
    ...
    expect(globalStyleSource).toContain('background: var(--atelier-white)')

...
describe('admin DashboardView', () => {
  ...
  it('keeps the Liquid Glass treatment scoped to admin dashboard modules', () => {
    ...
    expect(dashboardSource).toContain('--dashboard-glass-surface: rgba(255, 255, 255, 0.66);')
    expect(dashboardSource).toContain('backdrop-filter: blur(18px) saturate(1.2) contrast(1.02);')
    expect(dashboardSource).toContain('-webkit-backdrop-filter: blur(18px) saturate(1.2) contrast(1.02);')
    expect(dashboardSource).toContain('inset 0 1px 0 var(--dashboard-glass-edge)')

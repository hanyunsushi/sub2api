...
describe('admin DashboardView', () => {
  ...
  it('uses a single dashboard material card layer while keeping controls flat', () => {
    ...
    expect(dashboardSource).toContain('--dashboard-control-surface: var(--atelier-dust-soft);')
    expect(dashboardSource).toContain('--dashboard-control-edge: rgba(23, 21, 18, 0.14);')
    ...
    expect(dashboardSource).toContain('.admin-dashboard-atelier :deep(.card:nth-child(4n + 1))')
    expect(dashboardSource).toContain('--atelier-card-accent: var(--atelier-blue);')
    expect(dashboardSource).toContain('--atelier-card-accent: var(--atelier-dust);')
    expect(dashboardSource).toContain('--atelier-card-accent: var(--atelier-blue-dark);')
    expect(dashboardSource).toContain('--atelier-card-accent: var(--atelier-butter);')
    ...
    expect(dashboardSource).toContain('var(--atelier-blue-soft);')
    expect(dashboardSource).toContain('.admin-dashboard-atelier :deep(.card:nth-child(4n + 2))')
    expect(dashboardSource).toContain('var(--atelier-dust-soft);')
    ...
    expect(globalStyleSource).toContain('--atelier-surface: #11100d;')
    expect(globalMaterialSource).toContain('.dark :where(.card, .paper-card, .paper-surface, .stat-card, .summary-tile')

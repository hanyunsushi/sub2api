...
describe('admin DashboardView', () => {
  ...
  it('uses a single dashboard material card layer while keeping control glass scoped', () => {
    ...
    expect(globalStyleSource).toContain('rgba(3, 5, 10, 0.68)')
    ...
    expect(globalStyleSource).toContain('.app-layout-content :where(div, section, article).rounded-lg.bg-white')

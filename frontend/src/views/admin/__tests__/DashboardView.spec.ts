...
describe('admin DashboardView', () => {
  ...
  it('uses a single dashboard material card layer while keeping control glass scoped', () => {
    ...
    expect(dashboardSource).toContain('--dashboard-control-surface: rgba(255, 250, 240, 0.72);')
    ...
    expect(globalStyleSource).toContain('backdrop-filter: blur(20px) saturate(1.22) contrast(1.04);')
    expect(globalStyleSource).toContain('.dark .card')
    expect(globalStyleSource).toContain('rgba(5, 5, 5, 0.7)')

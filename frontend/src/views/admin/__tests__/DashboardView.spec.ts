...
describe('admin DashboardView', () => {
  ...
  it('uses a single dashboard material card layer while keeping controls flat', () => {
    ...
    expect(dashboardSource).toContain('--dashboard-control-edge: rgba(17, 24, 39, 0.14);')
    ...
    expect(dashboardSource).toContain('color: color-mix(in srgb, var(--atelier-blue) 72%, var(--atelier-white));')

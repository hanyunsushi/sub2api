<template>
  <component :is="isFullscreen ? 'div' : AppLayout" :class="isFullscreen ? 'flex min-h-screen flex-col justify-center bg-[var(--anthropic-section)] dark:bg-dark-950' : ''">
    <div :class="[isFullscreen ? 'p-4 md:p-6' : '', 'ops-dashboard-atelier space-y-6 pb-12']">
      <div
        v-if="errorMessage"

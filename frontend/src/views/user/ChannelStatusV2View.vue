<template>
  <AppLayout>
    <div class="space-y-6 pb-12">
      ...
      <section
        class="card channel-monitor-v2-header sticky top-0 z-20 !rounded-3xl !border-0 bg-[var(--anthropic-page)] p-0 shadow-sm ring-1 ring-gray-900/5 backdrop-blur-sm dark:!bg-dark-800 dark:ring-dark-700 supports-[backdrop-filter]:!bg-[var(--anthropic-page)] dark:supports-[backdrop-filter]:!bg-dark-800/95"
      >

<template>
  <AppLayout>
    <TablePageLayout class="user-usage-atelier" scroll-mode="page">
      ...
      <template #filters>
        <div class="card usage-filter-card">
          <div class="px-6 py-4">
          <div class="usage-filter-shell flex flex-wrap items-end gap-4">
            <div class="usage-filter-left flex flex-1 flex-wrap items-end gap-4">
            <!-- API Key Filter -->
        ...
        >
          ...
          <template #cell-tokens="{ row }">
            ...
            <div v-else class="flex items-center gap-1.5">
              ...
              >
                <div
                  class="flex h-4 w-4 cursor-help items-center justify-center rounded-full bg-gray-100 transition-colors dark:bg-gray-700"
                >
                  <Icon
                    name="infoCircle"
                    size="xs"

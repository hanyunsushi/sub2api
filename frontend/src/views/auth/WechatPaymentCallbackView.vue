  ...
  <div class="auth-standalone-shell min-h-screen bg-[var(--anthropic-section)] px-4 py-10 dark:bg-[var(--anthropic-section)]">
    <div class="mx-auto max-w-2xl">
      <div class="card p-6">
        ...
        >
          <div
            class="h-8 w-8 animate-spin rounded-full border-4 border-[var(--anthropic-fg)] border-t-transparent"
          ></div>
        </div>

        <div
          v-else
          class="mt-6 rounded-lg border border-[var(--anthropic-border)] bg-[var(--anthropic-section)] p-4 dark:border-[var(--anthropic-border)] dark:bg-[var(--anthropic-section)]"
        >

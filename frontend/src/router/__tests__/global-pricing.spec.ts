...
describe('global pricing route and navigation', () => {
  ...
  it('uses shared material card surfaces on maintained pricing modules', () => {
    ...
    expect(viewSource).toContain('--material-card-surface: var(--atelier-paper);')
    expect(viewSource).toContain('--material-card-surface: var(--atelier-material-blue);')
    expect(viewSource).toContain('--material-card-surface: var(--atelier-material-dust);')
    ...
    expect(viewSource).toContain('.summary-tile:nth-child(3)')
